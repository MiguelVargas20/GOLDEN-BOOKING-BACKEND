 ...
 */
final class PlantillasCorreoReserva {
    ...
    static String fecha(LocalDateTime fecha) {
        return fecha == null ? "—" : fecha.format(FORMATO_FECHA);
    }

    static String pesos(Double valor) {
    ...
    static String solicitudRecibida(String nombreCliente, Map<String, String> detalles) {
    ...
    static String reservaConfirmada(String nombreCliente, Map<String, String> detalles) {
    ...
    static String reservaCancelada(String nombreCliente, Map<String, String> detalles, String motivo, boolean porAdmin) {
