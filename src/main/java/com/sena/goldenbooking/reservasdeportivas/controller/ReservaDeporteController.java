package com.sena.goldenbooking.reservasdeportivas.controller;
...
import com.sena.goldenbooking.reservasdeportivas.service.ReservaDeporteService;
...
public class ReservaDeporteController {
    ...
    public ResponseEntity<ReservaDeporteDto> actualizarMiembros(@PathVariable String id, @Valid @RequestBody MiembrosDto cuerpo,
                                                          Authentication authentication) {
