...
public interface ReservaDeporteService {
    ...
    /**
     * Cambia el horario sin cancelar la reserva. Mismas reglas que al crear
     * (horario del espacio, sin cruces) y recalcula el precio. El CLIENTE solo
     * la suya, con 24 h de anticipación; si ya estaba aprobada vuelve a quedar
