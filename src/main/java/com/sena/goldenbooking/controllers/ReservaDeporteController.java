    ...
    public class ReservaDeporteController {
        ...
        // GET /api/reservas/deporte/ocupadas
        // FIX hallazgo #5: antes el calendario de disponibilidad (useReservasDeporte.js)
        // llamaba a listarTodas(), que es admin-only — para un CLIENTE normal esa llamada
        // fallaba (403) y se tragaba en un catch, así que el cliente nunca veía los
        // horarios ya ocupados antes de intentar reservar. Este endpoint sí es accesible
        // para ADMIN o CLIENTE (regla ya existente en SecurityConfig para GET /api/reservas/**)
        // y no expone el docUsuario del dueño, solo cancha + horario.
        @GetMapping("/ocupadas")
        public ResponseEntity<List<RangoOcupadoDeporteDto>> obtenerFechasOcupadas() {
